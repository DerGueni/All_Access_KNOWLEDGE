...
' Version: 3.2 - FIX: 127.0.0.1 statt localhost (WebView2 Bug)
' Erstellt: 2026-01-04
' Geaendert: 2026-01-26 - localhost -> 127.0.0.1
'
...
Private Function OpenHTMLviaCOM(formName As String, recordId As Long, WindowTitle As String) As Boolean
    ...
    ' 3. HTTP-URL bauen - WICHTIG: 127.0.0.1 statt localhost (WebView2 kann localhost nicht aufloesen!)
    httpUrl = "http://127.0.0.1:5000/shell.html?form=" & formName
