Attribute VB_Name = "InfoPDF"
Option Compare Database
Option Explicit

'Ausgabe Report als PDF

'DoCmd.OutputTo acOutputReport, "rpt_Auftrag", "PDF", "C:\Test\Test.pdf"

'Nur Reports, keine Formulare

'In Word als PDF - ohne PDF-Creator etc ...

'Const wdFormatPDF As Long = 17
'wdDoc.SaveAs2 "C:\Test\Test_" & iDokNr & ".pdf", wdFormatPDF
