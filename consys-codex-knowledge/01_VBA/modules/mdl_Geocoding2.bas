Attribute VB_Name = "mdl_Geocoding2"
...
'
'Public Function DistanceKm_DISABLED_mdl_Geocoding2(Lat1 As Double, Lon1 As Double, Lat2 As Double, Lon2 As Double) As Double
