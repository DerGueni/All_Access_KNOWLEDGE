Attribute VB_Name = "zDateTimeConverter"
Option Compare Text
Option Explicit
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
' Converts VBA DateTime to ISO8601 RFC3339 Time
Public Function ConvertToIsoTime(myDate As Date, includeTimezone As Boolean) As String
    ...
    Else
        ...
        formatStr = "yyyy-mm-ddThh:mm:ss.000" + hourOffsetStr + ":" + CStr(Format(minOffset, "00"))
