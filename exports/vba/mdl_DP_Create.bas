...
Select Case iNurAktiveMA
    Case 1 ' Nur Aktive
        strSQLWhere = " AND Anstellungsart_ID = 3 or Anstellungsart_ID = 5 or Anstellungsart_ID = 4 "
    Case 2 ' Nur Festangestellte  'Anstellungsart 3
        strSQLWhere = " AND Anstellungsart_ID = 3 "
    Case 3 ' Nur Minijobber  ' Anstellungsart 5 + 4
        strSQLWhere = " AND (Anstellungsart_ID = 5 OR Anstellungsart_ID = 4) "
    Case 4 ' Nur Unternehmer  ' IstSubunternehmer = True
        strSQLWhere = " AND IstSubunternehmer = True "
    Case Else ' Alle
        strSQLWhere = " AND Anstellungsart_ID = 3 or Anstellungsart_ID = 5 or Anstellungsart_ID = 4 or Anstellungsart_ID = 11 "
