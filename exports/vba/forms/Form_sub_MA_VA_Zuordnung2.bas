...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_sub_MA_VA_Zuordnung2"
...
' ' Felder PKW und Einsatzleitung ausblenden wenn Veranstalter_ID = 20760
    ...
    If lngVeranstalterID = 20760 Then
        Me.Controls("PKW").Visible = False
        Me.Controls("Einsatzleitung").Visible = False
    Else
        Me.Controls("PKW").Visible = True
        Me.Controls("Einsatzleitung").Visible = True
    End If
