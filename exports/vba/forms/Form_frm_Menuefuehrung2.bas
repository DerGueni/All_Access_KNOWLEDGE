...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_frm_Menuefuehrung2"
...
DoEvents
recsetSQL1 = "SELECT * FROM tbl_Menuefuehrung2 order by MenueNr, SortNr"
...
'i = Forms!frm_Menuefuehrung2("cboF" & iMenu).Column(0)
...
'Neu - Doppelklick nach Fehler funktioniert nicht - Array immer neu füllen
Form_Load
...
FormNummer = 0
i = 0
Ausnahme = "frm_Menuefuehrung_neu"
Ausnahme = "frm_menuefuehrung2"
