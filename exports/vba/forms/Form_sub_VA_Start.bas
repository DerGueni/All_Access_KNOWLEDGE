...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_sub_VA_Start"
...
On Error GoTo Err
    ...
    'Stunden- / Preisdaten neu berechnen
    Me.Parent!sub_MA_VA_Zuordnung.Form.calc_ZUO_Stunden_all (iVAStart_ID)
    ...
    If KeyCode = vbKeyReturn Or KeyCode = vbKeyTab Then
        ...
        Select Case True
            ...
            Case Len(st) = 3 And Right(st, 1) = ":"
                st = st & "00"
            Case Len(st) = 3
                st = "0" & Left(st, 1) & ":" & Right(st, 2)
            Case Len(st) = 4 And IsNumeric(st)
...
On Error Resume Next
    ...
    If KeyCode = vbKeyReturn Or KeyCode = vbKeyTab Then
        ...
        End Select
        If Me.VA_Start.Text <> st Then Me.VA_Start.Text = st
