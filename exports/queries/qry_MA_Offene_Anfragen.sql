...
WHERE (((tbl_MA_VA_Planung.VADatum)>Date()) AND ((tbl_MA_VA_Planung.Anfragezeitpunkt)>#1/1/2022#) AND ((tbl_MA_VA_Planung.Rueckmeldezeitpunkt) Is Null))
ORDER BY tbl_MA_VA_Planung.VADatum, tbl_MA_VA_Planung.Anfragezeitpunkt DESC;
