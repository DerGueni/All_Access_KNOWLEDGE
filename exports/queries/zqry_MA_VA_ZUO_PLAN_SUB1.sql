-- Query: zqry_MA_VA_ZUO_PLAN_SUB1
-- Type: 0
...
HAVING (((Right([Dat_VA_Von],4))=Year(Now())) AND ((tbl_MA_Mitarbeiterstamm.IstSubunternehmer)=True)) OR (((zqry_MA_VA_ZUO_PLAN_union.VADatum)>=Date())) OR (((zqry_MA_VA_ZUO_PLAN_union.VADatum)>=Date()))
