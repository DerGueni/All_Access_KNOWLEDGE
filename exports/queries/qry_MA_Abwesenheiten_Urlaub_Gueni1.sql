-- Query: qry_MA_Abwesenheiten_Urlaub_Gueni1
-- Type: 0
...
WHERE (((tbl_MA_NVerfuegZeiten.vonDat) Between #1/1/2023# And #12/31/2023#) AND ((tbl_MA_NVerfuegZeiten.Zeittyp_ID)="Urlaub") AND ((tbl_MA_Mitarbeiterstamm.Anstellungsart_ID)=3))
