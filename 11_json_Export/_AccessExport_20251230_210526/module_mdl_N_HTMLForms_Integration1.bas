...
' Auftragsverwaltung HTML oeffnen
...
' Dienstplan Objekt HTML oeffnen
Public Sub OpenDienstplanObjektHTML(Optional StartDatum As Date)
    Dim htmlPath As String
    htmlPath = HTML_BASE & "frm_N_DP_Dienstplan_Objekt.html"
    
    If StartDatum = 0 Then StartDatum = Date
    OpenHTMLForm htmlPath, "Planungsuebersicht", 1400, 800, "{""startDatum"":""" & Format(StartDatum, "yyyy-mm-dd") & """}"
End Sub

' Stundenauswertung HTML oeffnen
...
' Mitarbeiter Schnellauswahl HTML oeffnen
...
Private Function LoadSchnellauswahlJSON(VA_ID As Long, Datum As Date) As String
    ' Implementierung fuer Schnellauswahl
