"""
Aktualisiere den btn_N_ExcelOeffnen Button im Formular frm_MA_Mitarbeiterstamm
- Ändere Endung auf .xlsm
- Öffne automatisch im aktuellen Monat
"""
import sys
...
Private Sub btn_N_ExcelOeffnen_Click()
    ...
    ' Excel über COM öffnen um Monat zu wechseln
...
with AccessBridge() as bridge:
    print("=" * 70)
    print("AKTUALISIERE btn_N_ExcelOeffnen_Click")
    print("=" * 70)
    ...
    for comp in proj.VBComponents:
        if comp.Name == "Form_frm_MA_Mitarbeiterstamm":
            ...
            if start_line > 0 and end_line > 0:
                ...
                # Bereinige den Code (entferne führende/nachfolgende Leerzeilen)
