"""
Aktualisiere den btn_N_ExcelOeffnen Button - Excel in unterer Bildschirmhälfte
"""
import sys
...
# Neuer Code für den Button - Excel in unterer Bildschirmhälfte
new_code = '''
Private Sub btn_N_ExcelOeffnen_Click()
    ...
    lngScreenWidth = GetSystemMetrics32(0)   ' SM_CXSCREEN
    lngScreenHeight = GetSystemMetrics32(1)  ' SM_CYSCREEN
...
with AccessBridge() as bridge:
    print("=" * 70)
    print("AKTUALISIERE btn_N_ExcelOeffnen_Click - Untere Bildschirmhälfte")
    print("=" * 70)
