  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e5]:
      ...
      - generic [ref=e10]:
        ...
        - button "Kunden" [ref=e51] [cursor=pointer]
  ...
  - generic [ref=e40]:
    ...
    - iframe [ref=e61]:
      - generic [active] [ref=f19e1]:
        ...
        - generic [ref=f19e403]:
          - heading "API-Server nicht verfuegbar" [level=2] [ref=f19e404]
          - paragraph [ref=f19e405]: Der API-Server auf Port 5000 antwortet nicht. Das Formular kann keine Daten laden.
          - generic [ref=f19e406]:
            - strong [ref=f19e407]: "Server starten:"
            - code [ref=f19e408]: C:\Users\guenther.siegert\Documents\Access Bridge\start_api_hidden.vbs
          - button "Erneut versuchen" [ref=f19e409] [cursor=pointer]
          - button "Trotzdem fortfahren" [ref=f19e410] [cursor=pointer]
        - generic [ref=f19e412]:
          - heading "⚠️ API Server nicht erreichbar" [level=2] [ref=f19e413]
          - paragraph [ref=f19e414]:
            - text: Der
            - strong [ref=f19e415]: API Server
            - text: (Port 5000) ist nicht erreichbar. Das Formular kann keine Daten laden.
          - paragraph [ref=f19e416]:
            - strong [ref=f19e417]: "Lösung:"
            - text: Öffnen Sie das
            - strong [ref=f19e418]: Access-Frontend
            - text: (0_Consys_FE_Test.accdb).
            - text: Die Server starten automatisch beim Access-Start.
          - button "🔄 Erneut versuchen" [ref=f19e419] [cursor=pointer]
          - button "Schließen" [ref=f19e420] [cursor=pointer]
```
