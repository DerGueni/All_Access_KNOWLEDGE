...
export const Bridge = {
    ...
    async execute(action, params = {}) {
        switch (action) {
            ...
            case 'createMitarbeiter':
                return await Bridge.mitarbeiter.create(params);
            case 'updateMitarbeiter':
                return await Bridge.mitarbeiter.update(params.id, params);
            case 'deleteMitarbeiter':
                return await Bridge.mitarbeiter.delete(params.id);
    ...
    mitarbeiter: {
        ...
        create: (data) => apiPost('/mitarbeiter', data),
        update: (id, data) => apiPut(`/mitarbeiter/${id}`, data),
        delete: (id) => apiDelete(`/mitarbeiter/${id}`)
    },
